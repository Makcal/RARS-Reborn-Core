...
class XorTest {
    ...
    @BeforeEach
    void init() {
        xor = new Xor(new InstructionR.InstructionRParams((byte) 0, (byte) 1, (byte) 2));
        handler = new Xor.Handler();
    ...
    void xor() throws IllegalRegisterException {
        ...
        handler.handle(xor);
        assertEquals(0b010, register32File.getRegisterByNumber(0).getValue());
    }
}
