...
public class Fsgnjn_s extends InstructionR {
    public static final String NAME = "fsgnjn.s";
    ...
    public Fsgnjn_s(InstructionRParams data) {
    ...
    public static class Handler extends RiscV32InstructionHandler<Fsgnjn_s> {
        @Override
        public void handle(Fsgnjn_s instruction) throws IllegalRegisterException {
            instruction.exec(floatRegisterFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Fsgnjn_s> {
        @Override
        public Fsgnjn_s parse(String line) throws CompilationException {
