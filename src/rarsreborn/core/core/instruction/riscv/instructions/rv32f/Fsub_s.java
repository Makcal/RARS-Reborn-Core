...
public class Fsub_s extends InstructionR {
    public static final String NAME = "fsub.s";
    public static final byte OPCODE = 0b1010011;
    public static final byte FUNCT_3 = 0b0;
    public static final byte FUNCT_7 = 0b0000100;

    public Fsub_s(InstructionRParams data) {
    ...
    public static class Handler extends RiscV32InstructionHandler<Fsub_s> {
        @Override
        public void handle(Fsub_s instruction) throws IllegalRegisterException {
            instruction.exec(floatRegisterFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Fsub_s> {
        @Override
        public Fsub_s parse(String line) throws CompilationException {
