...
public class Fcvt_d_w extends InstructionR {
    ...
    public void exec(IRegisterFile<RegisterFloat64> floatRegisters, IRegisterFile<Register32> registers)
        ...
        floatRegisters.getRegisterByNumber(rd).setDouble(registers.getRegisterByNumber(rs1).getValue());
    }
    ...
    public static class Handler extends RiscV32InstructionHandler<Fcvt_d_w> {
        @Override
        public void handle(Fcvt_d_w instruction) throws IllegalRegisterException {
            instruction.exec(floatRegisterFile, registerFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Fcvt_d_w> {
        @Override
        public Fcvt_d_w parse(String line) throws CompilationException {
            ...
            return new Fcvt_d_w((byte) rd.getNumber(), (byte) rs1.getNumber());
        }
    }
}