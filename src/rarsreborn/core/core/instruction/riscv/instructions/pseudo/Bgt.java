...
public class Bgt implements IInstruction, ILinkableInstruction {
    public static final String NAME = "bgt";

    private final Blt base;
    protected LinkRequest linkRequest = null;

    public Bgt(byte rs1, byte rs2, short imm) {
        base = new Blt(new InstructionB.InstructionBParams(rs2, rs1, imm));
    }
    ...
    public static class Parser extends InstructionRegexParserRegisterBase<Bgt> {
        @Override
        public Bgt parse(String line) throws CompilationException {
