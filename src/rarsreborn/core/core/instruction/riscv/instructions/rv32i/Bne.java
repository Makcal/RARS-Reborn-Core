...
public class Bne extends InstructionB implements ILinkableInstruction {
    public static final String NAME = "bne";
    public static final byte OPCODE = 0b1100011;
    public static final byte FUNCT3 = 0x1;
    protected LinkRequest linkRequest;

    public Bne(InstructionBParams params) {
    ...
    public static class Handler extends RiscV32InstructionHandler<Bne> {
        @Override
        public void handle(Bne instruction) throws IllegalRegisterException {
            instruction.exec(registerFile, programCounter);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Bne> {
        @Override
        public Bne parse(String line) throws CompilationException {
            ...
            Bne instruction = new Bne(new InstructionBParams(
                (byte) rs1.getNumber(),
                (byte) rs2.getNumber(),
                (short) 0
            ));
