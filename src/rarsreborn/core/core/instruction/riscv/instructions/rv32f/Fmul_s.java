...
public class Fmul_s extends InstructionR {
    public static final String NAME = "fmul.s";
    public static final byte OPCODE = 0b1010011;
    public static final byte FUNCT_3 = 0b0;
    public static final byte FUNCT_7 = 0b0001000;

    public Fmul_s(InstructionRParams data) {
    ...
    public static class Handler extends RiscV32InstructionHandler<Fmul_s> {
        @Override
        public void handle(Fmul_s instruction) throws IllegalRegisterException {
            instruction.exec(floatRegisterFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Fmul_s> {
        @Override
        public Fmul_s parse(String line) throws CompilationException {
