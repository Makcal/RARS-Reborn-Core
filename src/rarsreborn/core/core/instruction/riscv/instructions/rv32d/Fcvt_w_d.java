...
public class Fcvt_w_d extends InstructionR {
    ...
    public void exec(IRegisterFile<RegisterFloat64> floatRegisters, IRegisterFile<Register32> registers)
        ...
        int result = Double.isNaN(value) ? Integer.MAX_VALUE : (int) value;
    ...
    public static class Handler extends RiscV32InstructionHandler<Fcvt_w_d> {
        @Override
        public void handle(Fcvt_w_d instruction) throws IllegalRegisterException {
            instruction.exec(floatRegisterFile, registerFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Fcvt_w_d> {
        @Override
        public Fcvt_w_d parse(String line) throws CompilationException {
            ...
            return new Fcvt_w_d((byte) rd.getNumber(), (byte) rs1.getNumber());
        }
    }
}