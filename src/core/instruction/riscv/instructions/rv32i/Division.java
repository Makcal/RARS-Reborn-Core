...
public class Division extends InstructionR {
    ...
    public Division(InstructionRParams data) {
    ...
    public static class Handler implements IInstructionHandler<Division> {
        ...
        @Override
        public void handle(Division instruction) {
            instruction.exec(registerFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Division> {
        @Override
        public Division parse(String line) throws CompilationException {
