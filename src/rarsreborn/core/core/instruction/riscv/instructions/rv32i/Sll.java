...
public class Sll extends InstructionR {
    ...
    public static class Handler extends RiscV32InstructionHandler<Sll> {
        @Override
        public void handle(Sll instruction) throws IllegalRegisterException {
            instruction.exec(registerFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Sll> {
        @Override
        public Sll parse(String line) throws CompilationException {
