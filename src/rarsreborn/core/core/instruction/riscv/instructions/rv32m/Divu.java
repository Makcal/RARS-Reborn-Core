...
public class Divu extends InstructionR {
    public static final String NAME = "divu";
    public static final byte OPCODE = 0b0110011;
    public static final byte FUNCT_3 = 0x05;
    public static final byte FUNCT_7 = 0x01;

    public Divu(InstructionRParams data) {
    ...
    public static class Handler extends RiscV32InstructionHandler<Divu> {
        @Override
        public void handle(Divu instruction) throws IllegalRegisterException {
            instruction.exec(registerFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Divu> {
        @Override
        public Divu parse(String line) throws CompilationException {
