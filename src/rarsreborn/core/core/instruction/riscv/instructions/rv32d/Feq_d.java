...
public class Feq_d extends InstructionR {
    public static final String NAME = "feq.d";
    ...
    public Feq_d(InstructionRParams data) {
    ...
    public static class Handler extends RiscV32InstructionHandler<Feq_d> {
        @Override
        public void handle(Feq_d instruction) throws IllegalRegisterException {
            instruction.exec(floatRegisterFile, registerFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Feq_d> {
        @Override
        public Feq_d parse(String line) throws CompilationException {
