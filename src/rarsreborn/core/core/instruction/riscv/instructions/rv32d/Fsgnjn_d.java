...
public class Fsgnjn_d extends InstructionR {
    public static final String NAME = "fsgnjn.d";
    ...
    public Fsgnjn_d(InstructionRParams data) {
    ...
    public static class Handler extends RiscV32InstructionHandler<Fsgnjn_d> {
        @Override
        public void handle(Fsgnjn_d instruction) throws IllegalRegisterException {
            instruction.exec(floatRegisterFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Fsgnjn_d> {
        @Override
        public Fsgnjn_d parse(String line) throws CompilationException {
