...
public class Bleu implements IInstruction, ILinkableInstruction {
    public static final String NAME = "ble";

    private final Bgeu base;
    protected LinkRequest linkRequest = null;

    public Bleu(byte rs1, byte rs2, short imm) {
        base = new Bgeu(new InstructionB.InstructionBParams(rs2, rs1, imm));
    }
    ...
    public static class Parser extends InstructionRegexParserRegisterBase<Bleu> {
        @Override
        public Bleu parse(String line) throws CompilationException {
            ...
            Bleu instruction = new Bleu((byte) rs1.getNumber(), (byte) rs2.getValue(), (short) 0);
