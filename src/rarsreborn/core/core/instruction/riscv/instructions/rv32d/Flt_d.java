...
public class Flt_d extends InstructionR {
    public static final String NAME = "flt.d";
    ...
    public Flt_d(InstructionRParams data) {
    ...
    public static class Handler extends RiscV32InstructionHandler<Flt_d> {
        @Override
        public void handle(Flt_d instruction) throws IllegalRegisterException {
            instruction.exec(floatRegisterFile, registerFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Flt_d> {
        @Override
        public Flt_d parse(String line) throws CompilationException {
