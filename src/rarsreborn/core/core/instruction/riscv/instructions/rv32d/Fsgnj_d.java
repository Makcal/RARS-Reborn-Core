...
public class Fsgnj_d extends InstructionR {
    public static final String NAME = "fsgnj.d";
    ...
    public Fsgnj_d(InstructionRParams data) {
    ...
    public static class Handler extends RiscV32InstructionHandler<Fsgnj_d> {
        @Override
        public void handle(Fsgnj_d instruction) throws IllegalRegisterException {
            instruction.exec(floatRegisterFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Fsgnj_d> {
        @Override
        public Fsgnj_d parse(String line) throws CompilationException {
