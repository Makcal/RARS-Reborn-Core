...
public class Fcvt_w_d_Impl extends InstructionR {
    ...
    public void exec(IRegisterFile<RegisterFloat64> floatRegisters, IRegisterFile<Register32> registers)
        ...
        if (isUnsigned())
            new Fcvt_wu_d(rd, rs1).exec(floatRegisters, registers);
        else
            new Fcvt_w_d(rd, rs1).exec(floatRegisters, registers);
    }
    ...
    public String getName() {
        return isUnsigned() ? Fcvt_wu_d.NAME : Fcvt_w_d.NAME;
    }
    ...
    public static class Handler extends RiscV32InstructionHandler<Fcvt_w_d_Impl> {
        @Override
        public void handle(Fcvt_w_d_Impl instruction) throws ExecutionException {
