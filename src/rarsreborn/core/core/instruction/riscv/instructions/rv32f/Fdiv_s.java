...
public class Fdiv_s extends InstructionR {
    public static final String NAME = "fdiv.s";
    public static final byte OPCODE = 0b1010011;
    public static final byte FUNCT_3 = 0b0;
    public static final byte FUNCT_7 = 0b0001100;

    public Fdiv_s(InstructionRParams data) {
    ...
    public static class Handler extends RiscV32InstructionHandler<Fdiv_s> {
        @Override
        public void handle(Fdiv_s instruction) throws IllegalRegisterException {
            instruction.exec(floatRegisterFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Fdiv_s> {
        @Override
        public Fdiv_s parse(String line) throws CompilationException {
