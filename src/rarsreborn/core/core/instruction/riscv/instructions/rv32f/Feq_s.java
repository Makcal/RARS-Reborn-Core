...
public class Feq_s extends InstructionR {
    public static final String NAME = "feq.s";
    ...
    public Feq_s(InstructionRParams data) {
    ...
    public static class Handler extends RiscV32InstructionHandler<Feq_s> {
        @Override
        public void handle(Feq_s instruction) throws IllegalRegisterException {
            instruction.exec(floatRegisterFile, registerFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Feq_s> {
        @Override
        public Feq_s parse(String line) throws CompilationException {
