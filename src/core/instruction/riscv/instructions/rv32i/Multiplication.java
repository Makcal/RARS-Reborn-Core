...
public class Multiplication extends InstructionR {
    ...
    public Multiplication(InstructionRParams data) {
    ...
    public static class Handler implements IInstructionHandler<Multiplication> {
        ...
        @Override
        public void handle(Multiplication instruction) {
            instruction.exec(registerFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Multiplication> {
        @Override
        public Multiplication parse(String line) throws CompilationException {
