...
public class Ori extends InstructionI implements ILinkableInstruction {
    ...
    public static class Parser extends InstructionRegexParserRegisterBase<Ori> {
        @Override
        public Ori parse(String line) throws CompilationException {
