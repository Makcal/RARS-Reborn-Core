...
class OriTest {
    ...
    @Test
    void orNegative() throws IllegalRegisterException, ImmediateTooLargeException {
        Ori ori = new Ori(new InstructionI.InstructionIParams((byte) 0, (byte) 1, (short) truncateNegative(-2, 12)));
