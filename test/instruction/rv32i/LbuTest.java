...
class LbuTest {
    ...
    @Test
    void lbu() throws MemoryAccessException, IllegalRegisterException {
    ...
    @Test
    void lbuTruncateLittleEndian() throws MemoryAccessException, IllegalRegisterException {
        lbu = new Lbu(new InstructionI.InstructionIParams((byte) 0, (byte) 1, (short) 0));
        register32File.getRegisterByNumber(1).setValue(Memory32.DATA_SECTION_START);
    ...
    @Test
    void lbuNegativeOffset() throws ImmediateTooLargeException, MemoryAccessException, IllegalRegisterException {
    ...
    @Test
    void lbuNegative() throws MemoryAccessException, IllegalRegisterException {
        lbu = new Lbu(new InstructionI.InstructionIParams((byte) 0, (byte) 1, (short) 0));
        register32File.getRegisterByNumber(1).setValue(Memory32.DATA_SECTION_START);
