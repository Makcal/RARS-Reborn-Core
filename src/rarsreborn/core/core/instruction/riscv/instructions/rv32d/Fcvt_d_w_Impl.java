...
public class Fcvt_d_w_Impl extends InstructionR {
    ...
    public void exec(IRegisterFile<RegisterFloat64> floatRegisters, IRegisterFile<Register32> registers)
        ...
        if (isUnsigned())
            new Fcvt_d_wu(rd, rs1).exec(floatRegisters, registers);
        else
            new Fcvt_d_w(rd, rs1).exec(floatRegisters, registers);
    }
    ...
    public String getName() {
        return isUnsigned() ? Fcvt_d_wu.NAME : Fcvt_d_w.NAME;
    }
    ...
    public static class Handler extends RiscV32InstructionHandler<Fcvt_d_w_Impl> {
        @Override
        public void handle(Fcvt_d_w_Impl instruction) throws ExecutionException {
