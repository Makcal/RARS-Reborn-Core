...
public class Add extends InstructionR {
    ...
    public Add(InstructionRParams data) {
    ...
    public static class Handler extends RiscV32InstructionHandler<Add> {
        @Override
        public void handle(Add instruction) throws IllegalRegisterException {
            instruction.exec(registerFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Add> {
        @Override
        public Add parse(String line) throws CompilationException {
