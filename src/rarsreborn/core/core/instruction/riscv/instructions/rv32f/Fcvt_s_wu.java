...
public class Fcvt_s_wu extends InstructionR {
    ...
    public void exec(IRegisterFile<RegisterFloat64> floatRegisters, IRegisterFile<Register32> registers)
        ...
        floatRegisters.getRegisterByNumber(rd).setFloat(
            (float) Integer.toUnsignedLong(registers.getRegisterByNumber(rs1).getValue())
        );
    }
    ...
    public static class Handler extends RiscV32InstructionHandler<Fcvt_s_wu> {
        @Override
        public void handle(Fcvt_s_wu instruction) throws IllegalRegisterException {
            instruction.exec(floatRegisterFile, registerFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Fcvt_s_wu> {
        @Override
        public Fcvt_s_wu parse(String line) throws CompilationException {
            ...
            return new Fcvt_s_wu((byte) rd.getNumber(), (byte) rs1.getNumber());
        }
    }
}