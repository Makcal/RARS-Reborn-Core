...
public class Fmin_s extends InstructionR {
    public static final String NAME = "fmin.s";
    ...
    public Fmin_s(InstructionRParams data) {
    ...
    public static class Handler extends RiscV32InstructionHandler<Fmin_s> {
        @Override
        public void handle(Fmin_s instruction) throws IllegalRegisterException {
            instruction.exec(floatRegisterFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Fmin_s> {
        @Override
        public Fmin_s parse(String line) throws CompilationException {
