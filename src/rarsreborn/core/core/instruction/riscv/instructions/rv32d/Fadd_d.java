...
public class Fadd_d extends InstructionR {
    public static final String NAME = "fadd.d";
    public static final byte OPCODE = 0b1010011;
    public static final byte FUNCT_3 = 0b0;
    public static final byte FUNCT_7 = 0b0000001;

    public Fadd_d(InstructionRParams data) {
    ...
    public static class Handler extends RiscV32InstructionHandler<Fadd_d> {
        @Override
        public void handle(Fadd_d instruction) throws IllegalRegisterException {
            instruction.exec(floatRegisterFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Fadd_d> {
        @Override
        public Fadd_d parse(String line) throws CompilationException {
