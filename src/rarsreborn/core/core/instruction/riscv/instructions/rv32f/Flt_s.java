...
public class Flt_s extends InstructionR {
    public static final String NAME = "flt.s";
    ...
    public Flt_s(InstructionRParams data) {
    ...
    public static class Handler extends RiscV32InstructionHandler<Flt_s> {
        @Override
        public void handle(Flt_s instruction) throws IllegalRegisterException {
            instruction.exec(floatRegisterFile, registerFile);
        }
    }

    public static class Parser extends InstructionRegexParserRegisterBase<Flt_s> {
        @Override
        public Flt_s parse(String line) throws CompilationException {
